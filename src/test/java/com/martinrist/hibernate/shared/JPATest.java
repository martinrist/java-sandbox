...
public class JPATest extends TransactionManagerTest {
    ...
    private static String[] hbmResources;
    public JPASetup JPA;
    ...
    public static void configurePersistenceUnit() throws Exception {
        configurePersistenceUnit(null);
    }

    public static void configurePersistenceUnit(String persistenceUnitName,
                                         String... hbmResources) throws Exception {
        JPATest.persistenceUnitName = persistenceUnitName;
        JPATest.hbmResources = hbmResources;
    }
